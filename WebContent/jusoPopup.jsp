...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIxMDEwODE3NDc0NTExMDY0NTg=" // 118.40.88.31   ip주소값
	/* var confmKey = "devU01TX0FVVEgyMDIxMDEwODE3MzMzMDExMDY0NTY="// localhost:9000 */
	/* var confmKey = "devU01TX0FVVEgyMDIxMDEwODE1NTEzMjExMDY0NDg="// localhost:8093 */
	/* "devU01TX0FVVEgyMDIxMDEwODE1NTEzMjExMDY0NDg=";//승인키 */ // localhost:8093
